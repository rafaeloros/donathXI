...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
    <p class="w3-left">Sugestii</p>
  </header>

  <!-- Image header -->
  <div class="w3-display-container w3-container">
    <img src="imagini/sugestii.jpg" alt="apometre" style="width:50%">
  </div>

  <div class="w3-container w3-text-grey" id="jeans">
        <p>Vă rugăm să ne trimiteți sugestii / reclamații folosind formularul de mai jos</p>
        <form action="mesaj.php">
        <!--
        <select name="tip_mesaj" class="w3-input w3-border">
<option value="sugestie" selected>Sugestie</option>
...
-->
          ...
          <p><input class="w3-input w3-border" type="text" placeholder="Subiect" name="Subiect" required></p>
          <p><textarea class="w3-input w3-border" name="Mesaj" rows="5" placeholder="Mesajul dumneavoastră"></textarea></p>
          <button type="submit" class="w3-button w3-block w3-red">Trimite</button>
        </form>
        <p></p>
  </div>
