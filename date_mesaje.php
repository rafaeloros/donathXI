...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
    <p class="w3-left">Sugestii / reclamatii</p>
  </header>
...
include("conn.php");
 ...
 class mesaj {
   ...
   if(isset($cnx)) {
      $cda = "SELECT * FROM mesaje ORDER BY id_mesaj DESC";
      $stmt = $cnx->prepare($cda);
    $stmt->execute();
      echo "<table style=\"width:100%; \">";
      $i=1; //  Contor de linii
      while ($mes = $stmt->fetchObject('mesaj')) {
         if ($i%2==0) {
        ...
        echo $mes->nume; echo "</td><td>";
        echo $mes->email; echo "</td><td>";
        echo $mes->subiect; echo "</td><td>";
        echo $mes->mesaj; echo "</td><tr>";
        echo "<tr><td> </td></tr>";
        $i++;
   }
   $cnx = null;
