...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
    <p class="w3-left">Noutăți</p>
  </header>

  <!-- Image header -->
  <div class="w3-display-container w3-container">
    <img src="imagini/donathXI.jpg" alt="bloc" style="width:50%">
    </div>

  <div class="w3-container w3-text-grey w3-display-container">
    <h1>Finanțare nouă</h1>
    <p>În urma concursului de proiecte desfășurat de către Primăria Cluj-Napoca, în data de 6 mai 2018, au fost anunțate priectele câștigătoare.</p>
    <p>Suntem fericiți să vă anunțăm că blocul nostru a primit o finanțare în valoare de 10000 de euro pentru amenajarea spațiului verde din spatele blocului, loc unde va fi înființat și un mic parc de copii, două parcări de biciclete și vor fi amplasate 2 grătare, fiecare din acestea cu 4 mese și bănci</p>
  </div>
