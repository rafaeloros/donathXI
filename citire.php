...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
    <p class="w3-left">Citire apometre</p>
  </header>

  <!-- Image header -->
  <div class="w3-display-container w3-container">
    <img src="imagini/cit_apa.jpg" alt="apometre" style="width:50%">
  </div>

  <div class="w3-container w3-text-grey">
    <p>Vă rugăm să folosiți formularul de mai jos pentru a transmite indexul apometrelor dumneavoastră.</p>
          <form action="contor_nou.php">
          <p><input class="w3-input w3-border" type="text" placeholder="Nume" name="Nume" required></p>
          <!--
          <select name="tip_mesaj" class="w3-input w3-border">
<option value="A" selected>Scara A</option>
<option value="B">Scara B</option>
<option value="C">Scara C</option>
<option value="D">Scara D</option>
</select>
-->
<p><input class="w3-input w3-border" type="text" placeholder="Scara" name="Scara" required></p>
<p><input class="w3-input w3-border" type="text" placeholder="Apartament" name="Apartament" required></p>
<p><input class="w3-input w3-border" type="text" placeholder="Apomentru Bucatarie" name="APA1" required></p>
<p><input class="w3-input w3-border" type="text" placeholder="Apomentru Baie" name="APA2" required></p>
<button type="submit" class="w3-button w3-block w3-red">Trimite</button></form>
<p></p>
  </div>
